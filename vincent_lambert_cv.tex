...
Création d’un jeu de rôle papier avec système de règles, lore, bêta-tests et quêtes. Création d’une langue avec
grammaire, vocabulaire, système d’écriture et donc fonte pour les fichiers numériques associés. Réalisation d’une
interface graphique avec JavaFx pour l’exploration du jeu, une modification aisée de ses variables et pour la
création assistée d’un personnage.
