...
\cvfr{Amélioration et préparation des paquets \tech{Python} et \tech{Unity} conçus pendant le doctorat (microrep et \textmu RepXR) pour leur mise à disposition publique. Création d'une application de démonstration de l'interaction par microgestes en Réalité Virtuelle pour la conférence francophone IHM'25 Toulouse en collaboration avec Charles Bailly (Immersion - Bordeaux) \cite{chaffangeoncaillet:hal-05311866}.
...
\cvfr{Suivi de projets par groupes de deux et soutenances (? heqTD). Les étudiants devaient identifier une question de recherche, préparer une revue de littérature et un protocole expérimental. Ensuite, ils devaient faire passer leur expérience, analyser les résultats et défendre leur projet dans une présentation de 20 minutes.}
\cven{Supervision of projects in groups of two and presentations (? heqTD). Studends were asked to identify a research question, prepare a literature review and an experimental plan. Then, they had to run their experiment, analyze the results and defend their project as a whole in a 20 minutes presentation.}
...
\cvfr{Suivi de projet (16,5 heqTD). Pour leurs projets, les étudiants étaient répartis en groupes de trois et devaient proposer un projet multimodal (2 modalités en dehors du toucher sur un écran) dans un contexte de mobilité (système mobile, embarqué ou déplacement dans un espace contrôlé). Leurs présentation devaient durer environ 20 minutes.}
\cven{Project follow-up (16,5 heqTD). For their projects, students were divided into groups of three and asked to propose a multimodal project (two modalities other than touch on a screen) in a mobility context (mobile system, embedded system, or movement in a controlled space). Their presentations should last about 20 minutes.}
...
\cvfr{Suivi de projet et soutenances (31 heqTD). Pour leurs projets, les étudiants étaient répartis en groupes de cinq et devaient proposer un projet multimodal (2 modalités en dehors du toucher sur un écran) dans un contexte de mobilité (système mobile, embarqué ou déplacement dans un espace contrôlé). Leurs présentation devaient durer environ 20 minutes.}
\cven{Project follow-up and presentations (31 heqTD). For their projects, students were divided into groups of five and asked to propose a multimodal project (two modalities other than touch on a screen) in a mobility context (mobile system, embedded system, or movement in a controlled space). Their presentations should last about 20 minutes.}
...
\cvfr{Suivi de projet (16,5 heqTD) et examen de 1h (rédaction de sujet et correction). Pour leurs projets, les étudiants étaient répartis en groupes de trois et devaient proposer un projet multimodal (2 modalités en dehors du toucher sur un écran) dans un contexte de mobilité (système mobile, embarqué ou déplacement dans un espace contrôlé). Leurs présentation devaient durer environ 20 minutes.}
\cven{Project follow-up (16,5 heqTD) and 1h exam (writing and correction). For their projects, students were divided into groups of three and asked to propose a multimodal project (two modalities other than touch on a screen) in a mobility context (mobile system, embedded system, or movement in a controlled space). Their presentations should last about 20 minutes.}
...
\cvfr{\cvsection{Projets personnels marquants}}\cven{\cvsection{Noteworthy personal projects}}
